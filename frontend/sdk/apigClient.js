...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://4xyxcazmua.execute-api.us-east-1.amazonaws.com/Prod';
    ...
    apigClient.uploadObjectKeyPut = function (params, body, additionalParams) {
        ...
        return apiGatewayClient.makeRequest(uploadObjectKeyPutRequest, authType, additionalParams, config.apiKey);
    };
    
    
    apigClient.uploadObjectKeyOptions = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
        
        apiGateway.core.utils.assertParametersDefined(params, [], ['body']);
        
        var uploadObjectKeyOptionsRequest = {
            verb: 'options'.toUpperCase(),
            path: pathComponent + uritemplate('/upload/{objectKey}').expand(apiGateway.core.utils.parseParametersToObject(params, [])),
            headers: apiGateway.core.utils.parseParametersToObject(params, []),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, []),
            body: body
        };
        ...
        return apiGatewayClient.makeRequest(uploadObjectKeyOptionsRequest, authType, additionalParams, config.apiKey);
    };
